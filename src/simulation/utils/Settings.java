...
public class Settings {
    public static final int DAY_DURATION = 500;                 // Длительность одного дня (в миллисекунах)
    ...
    public static final int REPRODUCE_CHANCE = 50;            // Шанс животного размножится (при наличии партнера)
    public static final int MOVE_CHANCE = 50;                 // Шанс животного перейти в другую локацию

    public static final int MAX_DAY_GROWING_COUNT = 2;        // Максимальный прирост растений в одной локации за 1 день
